...
\newacronym{rf}{RF}{resonance-fluorescence}
...
\newacronym{dpss}{DPSS}{diode-pumped solid state}
\newacronym{to}{TO}{transverse optical}
\newacronym{lo}{LO}{longitudinal optical}
\newacronym{epr}{EPR}{Einstein-Podolsky-Rosen}
\newacronym{ld}{LD}{Loss-DiVincenzo}
\newacronym{st}{ST}{singlet-triplet}
...
\newacronym{ggm}{GGM}{generalized Gell-Mann}
\newacronym{grape}{GRAPE}{gradient ascent pulse engineering}
\newacronym{crab}{CRAB}{chopped random-basis}
\newacronym{gksl}{GKSL}{Gorini-Kossakowski-Sudarshan-Lindblad}
\newacronym{spam}{SPAM}{state preparation and measurement}
\newacronym{iq}{IQ}{in-phase/quadrature}
\newacronym{cs}{CS}{computational subspace}
