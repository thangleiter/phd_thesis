...
% Choose the language
\ifxetexorluatex
    % TODO: https://github.com/reutenauer/polyglossia/issues/686
...
%\addbibresource[label=thesispubs,location=remote]{http://127.0.0.1:23119/better-bibtex/export/collection?/1/03_thesis_publications.biblatex&useJournalAbbreviation=true}
...
\ifxetexorluatex
    % These commmands in kaorefs add extra whitespace in the LOF
