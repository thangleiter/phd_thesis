...
\fi
\usepackage[autostyle=true,english=american]{csquotes}    % English quotes
...
\renewcommand{\LettrineFontHook}{
    \fontspec{Libertinus Serif Initials}
    %\color{RWTHblue100}
}
...
% Config
%----------------------------------------------------------------------------------------
% Slightly relax tex's layout to help line breaks
...
\DeclareCaptionLabelFormat{linked}{\hyperref[lof]{#1~#2}}
...
% Required somehow even if not used.
...
%----------------------------------------------------------------------------------------
% Comment this out if you want to compile individual pieces only
...
%    chs/appendices/setup,
%    chs/appendices/experiment,
