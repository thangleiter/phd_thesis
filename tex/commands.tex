...
\newcommand\spcm{Excelitas SPCM-850-14-FC\xspace}
\newcommand\ccd{Andor iDus 416\xspace}
\newcommand\spectrometer{Horiba FHR1000\xspace}
...
\newcommand\GaAsAlGaAs{\ensuremath{\ch{GaAs/Al_{$x$}Ga_{$1-x$}As}}\xspace}
...
\DeclareRobustCommand\importpgf[2]{%
    {\begingroup
