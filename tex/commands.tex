...
\newcommand{\thepower}[2]{\ensuremath{P = \qty{#1}{#2\watt}}\space}
...
\DeclareSIUnit{\permill}{\ensuremath{\mathrm{\textperthousand}}}
...
\newcommand{\sidehref}[2]{#2\sidenote{\url{#1}}\xspace}
\newcommand{\sideurl}[1]{\sidenote{\url{#1}}\xspace}
\newcommand{\imgsource}[1]{Generated by \repolink{#1}.\xspace}
\DeclareRobustCommand{\sampleid}[1]{Sample: \texttt{\detokenize{#1}}.\xspace}
...
\DeclareRobustCommand{\pyspeckpath}[2]{%
    {\begingroup%
        \hypersetup{hidelinks}%
        \href{https://git.rwth-aachen.de/qutech/python-spectrometer/-/tree/main/#1}{#2}%
    \endgroup}%
}
\DeclareRobustCommand{\mjolnirpath}[2]{%
    {\begingroup%
        \hypersetup{hidelinks}%
        \href{https://git-ce.rwth-aachen.de/qutech/lab_software/python-mjolnir/-/tree/main/#1}{#2}%
    \endgroup}%
}
