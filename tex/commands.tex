...
\newenvironment{pyblock}{%
    \par\vspace{0.25ex}\VerbatimEnvironment\begin{py}  % \par ensures vertical mode; optional spacing
        }{%
    \end{py}\par\vspace{0.25ex} % end with vertical mode + optional spacing
}
