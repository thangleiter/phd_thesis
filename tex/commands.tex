...
\newcommand{\codev}[1]{\texttt{#1}}  % for where minted/verbatim makes trouble, like inside captions etc
...
\newcommand{\Thethesis}{The present thesis\xspace}
...
\newcommand{\cmoscam}{Thorlabs DCC1545M \acrshort{cmos} camera\xspace}
...
\newcommand{\lmt}{\package{lindblad\_mc\_tools}}
...
\newcommand{\opteinsum}{\package{opt\_einsum}}
...
\DeclareSIUnit{\permill}{\text{\textperthousand}}
...
\newcommand{\eye}[0]{\ensuremath{\mathbb{1}}\xspace}
...
\DeclareRobustCommand{\repolink}[1]{%
    ...
    \texorpdfstring{%
        \hidelinkhref{https://github.com/thangleiter/phd_thesis/blob/main/#1}{\texttt{\detokenize{#1}}}%
    }{%
        % Fallback for PDF bookmarks and list entries
        \href{https://github.com/thangleiter/phd_thesis/blob/main/#1}{\texttt{\detokenize{#1}}}%
    }%
}
\newcommand{\pyspeckpath}[2]{\hidelinkhref{https://git.rwth-aachen.de/qutech/python-spectrometer/-/tree/v2025.9.1/#1}{#2}}
\newcommand{\mjolnirpath}[2]{\hidelinkhref{https://git.rwth-aachen.de/qutech/mjolnir/-/tree/v0.2.0/#1}{#2}}
\newcommand{\mjolnirapidoc}[2]{\texorpdfstring{\hidelinkhref{https://qutech.pages.rwth-aachen.de/mjolnir/_autogen/#1}{#2}}{#2}}
\newcommand{\driversource}[2]{\texorpdfstring{\hidelinkhref{#1}{#2}}{#2}}
