...
% Wrap py to always start in vertical mode
\newenvironment{pycode}{%
  \par\addvspace{\topsep}\VerbatimEnvironment\begin{py}  % \par ensures vertical mode; optional spacing
}{%
  \end{py}\par\addvspace{\topsep} % end with vertical mode + optional spacing
}
