...
% Only if not working in IDEA TeXiFy
%\addbibresource[location=remote]{http://127.0.0.1:23119/better-bibtex/export/collection?/1/02_phd_thesis.biblatex&useJournalAbbreviation=true}
...
\cleardoublepage\include{FrontBackmatter/Software}
...
\cleardoublepage
\part{Some Kind of Manual}\label{part:manual}
...
\part{The Showcase}\label{part:showcase}
