...
%	\end{flushleft}
%}
\hypertarget{lof}{\listoffigures} % Output the list of figures
...
\include{chs/filter_functions/comment}
...
\include{chs/appendices/setup/optics}
\include{chs/appendices/setup/vibrations}
\include{chs/appendices/experiment/tmm}
\include{chs/appendices/experiment/observations}
\include{chs/appendices/filter_functions/filter_functions}
\include{chs/appendices/filter_functions/second_order_concatenation}
\include{chs/appendices/filter_functions/time_domain_methods}
