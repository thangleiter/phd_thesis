...
\title[Millikelvin confocal microscopy and filter-function formalism]{
...
\addcontentsline{toc}{chapter}{\listfigurename} % Add the preface to the table of contents as a chapter
