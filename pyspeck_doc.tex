...
% Override references to the thesis
\renewcommand{\thethesis}{this document\xspace}
\renewcommand{\Thethesis}{This document\xspace}
\renewcommand{\thispart}{this document\xspace}
\renewcommand{\Thispart}{This document\xspace}
...
\title{A Flexible \python Tool For Fourier-Transform Noise Spectroscopy\thanks{This document has been extracted from Tobias Hangleiter's PhD. thesis, available at: \url{https://github.com/thangleiter/phd_thesis}.}}
\date{\today}
