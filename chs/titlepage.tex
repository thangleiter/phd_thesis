...
\renewcommand*{\maketitle}{%
    \begin{titlepage}
        ...
        \begin{german}
            Von der Fakultät für Mathematik und Naturwissenschaften der RWTH Aachen University zur Erlangung des akademischen Grades eines Doktors der Naturwissenschaften genehmigte Dissertation \\
            ...
            \begin{flushleft}
                \vspace{2\bigskipamount}
                {
                    ...
                    \medskip Tag der mündlichen Prüfung: 24.03.2026 \\
                    \medskip Diese Dissertation ist auf den Internetseiten der Universitätsbibliothek verfügbar.
                }
            \end{flushleft}
        \end{german}
    \end{titlepage}
...
\lowertitleback{
    ...
    \textbf{Colophon} \\
    This document was typeset with the help of \href{https://sourceforge.net/projects/koma-script/}{\KOMAScript} and \href{https://www.luatex.org/}{Lua\LaTeX} using the \href{https://github.com/fmarotta/kaobook/}{kaobook} class. \\
