...
\end{align}
The innermost integral approaches a $\delta$-function for large $T$, allowing us to further simplify this under the limit as\sidenote{
    We normalize the $\delta$-function such that $1 = \int\ddf{\omega}\delta(\omega)$.
}
\begin{align}
