...
To become familiar with the quantities $C(\tau)$ and $S(\omega)$, consider the Ornstein\hyp{}Uhlenbeck process~\cite{Uhlenbeck1930}, the only stationary Gaussian Markovian stochastic process~\cite{VanKampen1976}.
