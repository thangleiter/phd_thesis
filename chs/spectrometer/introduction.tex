...
A well-thought-out experimental setup is hence one that has been designed taking the various noise sources into consideration, and state\hyp{}of\hyp{}the\hyp{}art experiments often need to push the frontier in order to be successful.
...
Noise, in the sense that we are concerned with in \thethesis,\sidenote[][*-3]{
...
is a stochastic process, meaning that we cannot predict with certainty a dynamical system's time evolution; it \emph{fluctuates} randomly around its noise-free value.\sidenote[][*5]{
