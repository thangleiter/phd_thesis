...
He simply calls %\code{spect.hide(*range(2, 10))}
%\begin{py}
...
Charlie pulls up the \code{Spectrometer} session stored on his disk, allowing them to interactively discuss the spectra:
\begin{py}
