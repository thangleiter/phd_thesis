...
A more detailed numerical simulation could serve to pinpoint areas of improvement besides fairly obvious solutions such as mirrors below the sample or mode-engineering such as the approach pursued in \citer{Wu2024}.
...
Lastly, in \cref{ch:setup:vibrations}, I addressed the impact of vibrations, chiefly induced by the \gls{ptr}, on the microscope performance.
...
The chip used to measure \g2 in \cref{sec:setup:optics:g2} was grown by Xuelin Jin.
