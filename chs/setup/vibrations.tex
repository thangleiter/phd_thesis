...
There, the \emph{acceleration} noise floor was white,\sidenote{
    Remember that as acceleration is the second time derviative of displacement, in frequency space it is proportional to $f^2$ times the latter (\cref{eq:speck:fourier_derivative}).
}
