...
\textcite{Caparrelli2006} employed active control of a sample stage at \qty{3}{\kelvin} to attenuate vibrations.
\textcite{Pelliccione2013,Oh2021,Esser2024} constructed scanning gate microscopes in \gls{ptr}-cooled systems, demonstrating excellent displacement noise.
\textcite{Kalra2016} investigated the impact of \gls{ptr}-vibrations on electrical noise while \textcite{Riabzev2009,Olivieri2017,Schmoranzer2019} investigated the generation and decoupling of vibrations.
...
\begin{marginfigure}
    ...
    \caption[\imgsource{img/pdf/setup/springs.py}]{
        Force transmission function of a damped harmonic oscillator with $\gamma=\omega_0/200$ (solid black line) and $\gamma=\omega_0/2$ (dashed black line).
...
The \glspl{vc} are defined in terms of band-limited \gls{rms} values similar to what we have employed in \cref{part:speck} (\cf \cref{eq:speck:psd:bandpower}).
...
However, prompted by a sudden increase in visually observed vibrations in the microscope image, I modified the cryostat frame to house three air springs~\sidecite{CFMSchiller} in the hopes of isolating the microscope from external disturbances.\sidenote{
    ...
    Fortuitiously, the endeavor still proved successful and resulted in an improved vibration performance as I show below.
}
...
\begin{marginfigure}[*-7]
    \centering
    \input{img/tikz/setup/suspension}
...
It was first studied in the context of electron transport by \textcite{Schottky1918} and results from the discrete nature of, in our case, photons and their stochastic emission times~\cite{Blanter2000}.
