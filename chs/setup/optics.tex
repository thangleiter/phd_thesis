...
Together with the collection efficiency (\cref{eq:setup:optics:coupling:efficiency:collection}) and accounting for the transmittivity of the \gls{bs}, $\transmittance\approx\qty{87}{\percent}$,\sidenote[][*-2]{
...
\begin{align}
    \tilde{g}\gth{2}(\tau) &= \frac{1}{\sigma\sqrt{2\pi}}\int\dd{\tau^\prime} g\gth{2}(\tau^\prime)\e^{-\left(\tau - \tau^\prime\right)^2/2\sigma^2} \notag \\
                           &= \begin{aligned}[t]
                                1
                                & - \frac{1}{2}\left[
                                    \e^{\gamma\alpha_{-}}\erfc\left(\frac{\beta_{-}}{\sigma\sqrt{2}}\right)
                                    + \e^{\gamma\alpha_{+}}\erfc\left(\frac{\beta_{+}}{\sigma\sqrt{2}}\right)
                                \right] \\
                                & + \left[
                                    \e^{\gamma\alpha^{\prime}_{-}}\erfc\left(\frac{\beta^{\prime}_{-}}{\sigma\sqrt{2}}\right)
                                    + \e^{\gamma\alpha^{\prime}_{+}}\erfc\left(\frac{\beta^{\prime}_{+}}{\sigma\sqrt{2}}\right)
                                \right]
                           \end{aligned}\label{eq:setup:optics:g2:fit}
\end{align}
with
\begin{align}
    \alpha_{\pm} &= \frac{\gamma\sigma^2}{2} \pm \abs{\tau}, & \beta_{\pm} &= \gamma\sigma^2 \pm \abs{\tau}, \\
    \alpha^{\prime}_{\pm} &= \frac{\gamma\sigma^2 \pm 4\abs{\tau}}{8}, & \beta^{\prime}_{\pm} &= \frac{\gamma\sigma^2 \pm 2\abs{\tau}}{2}.
\end{align}
...
The dashed green line is the deconvoluted function (\cref{eq:setup:optics:g2:explicit}).
