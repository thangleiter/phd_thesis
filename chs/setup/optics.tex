...
A dipole oriented along $x$ in the plane of a \ch{GaAs} \gls{qw} buried at a distance $d$ beneath the surface of the sample emits light into the halfspace above it.
...
With the distance of a point in the lens plane from the dipole given by $r = \sqrt{r_{x}^2 + y^2}$, we can finally write the electric field amplitude in the lens plane as
\begin{equation}
