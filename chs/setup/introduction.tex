...
\begin{partcontribs}
    ...
    Thomas Descamps\sidenote[a]{Then at RWTH Aachen University and Forschungszentrum Jülich.} and Feng Liu\sidenotemark[a] originally designed the setup together with Hendrik Bluhm\sidenote[b]{RWTH Aachen University and Forschungszentrum Jülich.} and constructed it.
    Julian Ritzmann\sidenote[c]{Ruhr-Universität Bochum.} and Arne Ludwig\sidenotemark[c] grew the wafer on which Matthias Künne fabricated the sample used to measure the electron temperature in \cref{sec:setup:cooling:etemp}.
    The chip used to measure photon antibunching in \cref{sec:setup:optics:g2} was grown by Xuelin Jin.\sidenote[d]{Forschungszentrum Jülich.}
    Marcus Eßer\sidenote[e]{RWTH Aachen University.} kindly lent the accelerometer used in \cref{sec:setup:vibrations:accel}.
\end{partcontribs}
