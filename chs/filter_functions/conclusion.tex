...
\AutoLettrine{Before} we conclude, let us address two possible avenues for future work, one for the formalism itself and one for its application.
...
For future applications of our method, it would be interesting to study the effects of noise correlations on the performance of \gls{qec} schemes~\cite{Devitt2013,Ng2011,Nickerson2019,Clader2021,Liu2024a}.
