...
Because the exciton Bohr radius in the plane, $a_{\mr{B}}\gth{2D}$ (\cref{eq:exp:theory:qcse:bohr_radius_2d}), is much smaller than the oscillator length $\xi$, we separate the exciton's center-of-mass motion from the relative electron-hole motion in the plane~\cite{Kavokin1994}.
