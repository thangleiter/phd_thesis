...
Famously envisioned by \textcite{Kimble2008}, the concept can be extended to the notion of a \emph{quantum internet}~\cite{Wehner2018}.
...
Although a comprehensive resource assessment of the feasibility of such approaches is still outstanding, initial results are promising~\cite{Jacinto2026}, and experimental demonstrations of small computations have recently been shown~\cite{Main2025}.
...
\textcite{Briegel1998,Dur1999} then proposed a quantum repeater protocol that uses entanglement swapping, enhanced by entanglement distillation,\sidenote{
...
\textcite{Muralidharan2016} analyzed the resource requirements of three quantum repeater generations and identified optimal architectures for different parameter regimes.
...
Because of the exponential dependence of the tunnel coupling strength on the distance, this alignment needs to be very precise indeed.

An alternative to a \gls{saqd} was proposed by \textcite{Descamps2021} in the form of an electrostatic exciton trap.
