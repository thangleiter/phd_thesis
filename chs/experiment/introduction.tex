...
\begin{partcontribs}
    ...
    Thomas Descamps\sidenote[c]{Then at RWTH Aachen University and Forschungszentrum Jülich.} fabricated the sample \textsc{Doped M1\_05\_49-2}.
    Sebastian Kindel\sidenote[d]{RWTH Aachen University and Forschungszentrum Jülich.} fabricated the samples \textsc{Honey H13} and \textsc{Fig F10}.
\end{partcontribs}
