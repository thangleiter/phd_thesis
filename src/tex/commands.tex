...
\newcommand{\pyspeck}{\package{python\_spectrometer}\xspace}
\newcommand{\filterfunctions}{\package{filter\_functions}\xspace}
\newcommand{\qupulse}{\package{qupulse}\xspace}
\newcommand{\qopt}{\package{qopt}\xspace}
\newcommand{\numpy}{\package{NumPy}\xspace}
\newcommand{\scipy}{\package{SciPy}\xspace}
\newcommand{\matplotlib}{\package{matplotlib}\xspace}
\newcommand{\qutip}{\package{QuTiP}\xspace}
\newcommand{\sparse}{\package{sparse}\xspace}
\newcommand{\opteinsum}{\package{opt\_einsum}\xspace}
\newcommand{\jupyter}{\package{Jupyter}\xspace}
