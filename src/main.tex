...
\pagelayout{wide} % No margins
\addpart{A \python Welch's-method Spectrometer}\label{part:spectrometer}
\pagelayout{margin} % Restore margins

\pagelayout{wide} % No margins
\addpart{Improvements and Characterization of a Millikelvin Confocal Microscope}\label{part:setup}
\pagelayout{margin} % Restore margins
...
\input{chs/filter_functions/introduction}
\input{chs/filter_functions/validation}
%\input{chs/filter_functions/prr.tex}
