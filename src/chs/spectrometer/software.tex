...
\end{marginfigure}
The \pyspeck package provides a central class, \code[breakanywhere]{Spectrometer}, that users interact with to perform data acquisition, spectrum estimation, and plotting.
