...
\begin{margintable}
    ...
    \caption[Overview of spectrum estimation parameters]{
        Variable names used in \cref{ch:speck:theory} and their corresponding parameter names as used in \pyspeck and \code{scipy.signal.welch()}~\cite{scipy_welch}.
    }
...
The \pyspeck package provides a single user-facing class, the \code{Spectrometer}