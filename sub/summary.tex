...
\begin{german}
    ...
    Anschließend beschreibe ich das \texttt{mjolnir} Softwarepaket für optische Messungen von elektrostatischen Exzitonfallen in Halbleitermembranen und präsentiere umfangreiche Messungen auf der Suche nach Signaturen von Einzelphotonenemittern.
    ...
    Ich präsentiere schließlich das \texttt{filter\_functions} Softwarepaket, das die einfache Berechnung der Filterfunktionen ermöglicht, und diskutiere ausgewählte Anwendungsbeispiele.
\end{german}
